...
struct TBCTL_BITS
{                       // bits description
    vu16 CTRMODE   : 2; // 1:0 Counter Mode
    vu16 PHSEN     : 1; // 2 Phase Load Enable
    vu16 PRDLD     : 1; // 3 Active Period Load
    vu16 SYNCOSEL  : 2; // 5:4 Sync Output Select
    vu16 SWFSYNC   : 1; // 6 Software Force Sync Pulse
    vu16 HSPCLKDIV : 3; // 9:7 High Speed TBCLK Pre-scaler
    vu16 CLKDIV    : 3; // 12:10 Time Base Clock Pre-scaler
    vu16 PHSDIR    : 1; // 13 Phase Direction Bit
    vu16 FREE_SOFT : 2; // 15:14 Emulation Mode Bits
};
...
{                          // bits description
    ...
    vu16 rsvd2        : 1; // 5 Reserved
    vu16 OSHTSYNCMODE : 1; // 6 One shot sync mode
    vu16 OSHTSYNC     : 1; // 7 One shot sync
    vu16 rsvd3        : 4; // 11:8 Reserved
    vu16 SYNCOSELX    : 2; // 13:12 Syncout selection
    vu16 PRDLDSYNC    : 2; // 15:14 PRD Shadow to Active Load on SYNC Event
};
...
struct TBSTS_BITS
{                     // bits description
    vu16 CTRDIR : 1;  // 0 Counter Direction Status
    vu16 SYNCI  : 1;  // 1 External Input Sync Status
    vu16 CTRMAX : 1;  // 2 Counter Max Latched Status
...
struct CMPCTL_BITS
{                       // bits description
    vu16 LOADAMODE : 2; // 1:0 Active Compare A Load
    vu16 LOADBMODE : 2; // 3:2 Active Compare B Load
    vu16 SHDWAMODE : 1; // 4 Compare A Register Block Operating Mode
    vu16 rsvd1     : 1; // 5 Reserved
    vu16 SHDWBMODE : 1; // 6 Compare B Register Block Operating Mode
    vu16 rsvd2     : 1; // 7 Reserved
    vu16 SHDWAFULL : 1; // 8 Compare A Shadow Register Full Status
    vu16 SHDWBFULL : 1; // 9 Compare B Shadow Register Full Status
    vu16 LOADASYNC : 2; // 11:10 Active Compare A Load on SYNC
    vu16 LOADBSYNC : 2; // 13:12 Active Compare B Load on SYNC
    vu16 rsvd3     : 2; // 15:14 Reserved
};
...
struct CMPCTL2_BITS
{                       // bits description
    vu16 LOADCMODE : 2; // 1:0 Active Compare C Load
    vu16 LOADDMODE : 2; // 3:2 Active Compare D load
    vu16 SHDWCMODE : 1; // 4 Compare C Block Operating Mode
    vu16 rsvd1     : 1; // 5 Reserved
    vu16 SHDWDMODE : 1; // 6 Compare D Block Operating Mode
    vu16 rsvd2     : 3; // 9:7 Reserved
    vu16 LOADCSYNC : 2; // 11:10 Active Compare C Load on SYNC
    vu16 LOADDSYNC : 2; // 13:12 Active Compare D Load on SYNC
    vu16 rsvd3     : 2; // 15:14 Reserved
};
...
struct DBCTL_BITS
{                           // bits description
    vu16 OUT_MODE      : 2; // 1:0 Dead Band Output Mode Control
    vu16 POLSEL        : 2; // 3:2 Polarity Select Control
    vu16 IN_MODE       : 2; // 5:4 Dead Band Input Select Mode Control
    vu16 LOADREDMODE   : 2; // 7:6 Active DBRED Load Mode
    vu16 LOADFEDMODE   : 2; // 9:8 Active DBFED Load Mode
    vu16 SHDWDBREDMODE : 1; // 10 DBRED Block Operating Mode
    vu16 SHDWDBFEDMODE : 1; // 11 DBFED Block Operating Mode
    vu16 OUTSWAP       : 2; // 13:12 Dead Band Output Swap Control
    vu16 DEDB_MODE     : 1; // 14 Dead Band Dual-Edge B Mode Control
    vu16 HALFCYCLE     : 1; // 15 Half Cycle Clocking Enable
};
...
struct DBCTL2_BITS
{                            // bits description
    vu16 LOADDBCTLMODE : 2;  // 1:0 DBCTL Load from Shadow Mode Select
    vu16 SHDWDBCTLMODE : 1;  // 2 DBCTL Load mode Select
    vu16 rsvd1         : 13; // 15:3 Reserved
};
...
struct AQCTL_BITS
{                         // bits description
    vu16 LDAQAMODE   : 2; // 1:0 Action Qualifier A Load Select
    vu16 LDAQBMODE   : 2; // 3:2 Action Qualifier B Load Select
    vu16 SHDWAQAMODE : 1; // 4 Action Qualifer A Operating Mode
    vu16 rsvd1       : 1; // 5 Reserved
    vu16 SHDWAQBMODE : 1; // 6 Action Qualifier B Operating Mode
    vu16 rsvd2       : 1; // 7 Reserved
    vu16 LDAQASYNC   : 2; // 9:8 AQCTLA Register Load on SYNC
    vu16 LDAQBSYNC   : 2; // 11:10 AQCTLB Register Load on SYNC
    vu16 rsvd3       : 4; // 15:12 Reserved
};
...
{                   // bits description
    vu16 T1SEL : 4; // 3:0 T1 Event Source Select Bits
    vu16 T2SEL : 4; // 7:4 T2 Event Source Select Bits
...
struct PCCTL_BITS
{                     // bits description
    vu16 CHPEN   : 1; // 0 PWM chopping enable
    vu16 OSHTWTH : 4; // 4:1 One-shot pulse width
    vu16 CHPFREQ : 3; // 7:5 Chopping clock frequency
    vu16 CHPDUTY : 3; // 10:8 Chopping clock Duty cycle
...
struct VCAPCTL_BITS
{                            // bits description
    vu16 VCAPE          : 1; // 0 Valley  Capture mode
    vu16 VCAPSTART      : 1; // 1 Valley  Capture Start
    vu16 TRIGSEL        : 3; // 4:2 Capture Trigger Select
    vu16 rsvd1          : 2; // 6:5 Reserved
    vu16 VDELAYDIV      : 3; // 9:7 Valley Delay Mode Divide Enable
    vu16 EDGEFILTDLYSEL : 1; // 10 Valley Switching Mode Delay Select
    vu16 rsvd2          : 5; // 15:11 Reserved
};
...
struct VCNTCFG_BITS
{                          // bits description
    vu16 STARTEDGE    : 4; // 3:0 Counter Start Edge Selection
    vu16 rsvd1        : 3; // 6:4 Reserved
    vu16 STARTEDGESTS : 1; // 7 Start Edge Status Bit
    vu16 STOPEDGE     : 4; // 11:8 Counter Start Edge Selection
    vu16 rsvd2        : 3; // 14:12 Reserved
    vu16 STOPEDGESTS  : 1; // 15 Stop Edge Status Bit
};
...
struct HRCNFG_BITS
{                      // bits description
    vu16 EDGMODE  : 2; // 1:0 ePWMxA Edge Mode Select Bits
    vu16 CTLMODE  : 1; // 2 ePWMxA Control Mode Select Bits
    vu16 HRLOAD   : 2; // 4:3 ePWMxA Shadow Mode Select Bits
    vu16 SELOUTB  : 1; // 5 EPWMB Output Selection Bit
    vu16 AUTOCONV : 1; // 6 Autoconversion Bit
    vu16 SWAPAB   : 1; // 7 Swap EPWMA and EPWMB Outputs Bit
    vu16 EDGMODEB : 2; // 9:8 ePWMxB Edge Mode Select Bits
    vu16 CTLMODEB : 1; // 10 ePWMxB Control Mode Select Bits
    vu16 HRLOADB  : 2; // 12:11 ePWMxB Shadow Mode Select Bits
    vu16 rsvd1    : 1; // 13 Reserved
...
struct HRPWR_BITS
{                      // bits description
    vu16 rsvd1    : 2; // 1:0 Reserved
    vu16 rsvd2    : 1; // 2 Reserved
    vu16 rsvd3    : 1; // 3 Reserved
    vu16 rsvd4    : 1; // 4 Reserved
    vu16 rsvd5    : 1; // 5 Reserved
    vu16 rsvd6    : 4; // 9:6 Reserved
    vu16 rsvd7    : 5; // 14:10 Reserved
    vu16 CALPWRON : 1; // 15 Calibration Power On
};
...
struct HRMSTEP_BITS
{                     // bits description
    vu16 HRMSTEP : 8; // 7:0 High Resolution Micro Step Value
    vu16 rsvd1   : 8; // 15:8 Reserved
};
...
struct HRCNFG2_BITS
{                          // bits description
    vu16 EDGMODEDB    : 2; // 1:0 Dead-Band Edge-Mode Select Bits
    vu16 CTLMODEDBRED : 2; // 3:2 DBRED Control Mode Select Bits
    vu16 CTLMODEDBFED : 2; // 5:4 DBFED Control Mode Select Bits
    vu16 rsvd1        : 8; // 13:6 Reserved
...
struct HRPCTL_BITS
{                          // bits description
    vu16 HRPE         : 1; // 0 High Resolution Period Enable
    vu16 PWMSYNCSEL   : 1; // 1 EPWMSYNCPER Source Select
    vu16 TBPHSHRLOADE : 1; // 2 TBPHSHR Load Enable
    vu16 rsvd1        : 1; // 3 Reserved
    vu16 PWMSYNCSELX  : 3; // 6:4 EPWMSYNCPER Extended Source Select Bit:
    vu16 rsvd2        : 9; // 15:7 Reserved
};
...
struct TRREM_BITS
{                    // bits description
    vu16 TRREM : 11; // 10:0 HRPWM Remainder Bits
    vu16 rsvd1 : 5;  // 15:11 Reserved
};
...
struct GLDCTL_BITS
{                      // bits description
    vu16 GLD      : 1; // 0 Global Shadow to Active load event control
    vu16 GLDMODE  : 4; // 4:1 Shadow to Active Global Load Pulse Selection
    vu16 OSHTMODE : 1; // 5 One Shot Load mode control bit
    vu16 rsvd1    : 1; // 6 Reserved
    vu16 GLDPRD   : 3; // 9:7 Global Load Strobe Period Select Register
    vu16 GLDCNT   : 3; // 12:10 Global Load Strobe Counter Register
...
struct GLDCFG_BITS
{                            // bits description
    vu16 TBPRD_TBPRDHR  : 1; // 0 Global load event configuration for TBPRD:TBPRDHR
    vu16 CMPA_CMPAHR    : 1; // 1 Global load event configuration for CMPA:CMPAHR
    vu16 CMPB_CMPBHR    : 1; // 2 Global load event configuration for CMPB:CMPBHR
    vu16 CMPC           : 1; // 3 Global load event configuration for CMPC
    vu16 CMPD           : 1; // 4 Global load event configuration for CMPD
    vu16 DBRED_DBREDHR  : 1; // 5 Global load event configuration for DBRED:DBREDHR
    vu16 DBFED_DBFEDHR  : 1; // 6 Global load event configuration for DBFED:DBFEDHR
    vu16 DBCTL          : 1; // 7 Global load event configuration for DBCTL
    vu16 AQCTLA_AQCTLA2 : 1; // 8 Global load event configuration for AQCTLA/A2
    vu16 AQCTLB_AQCTLB2 : 1; // 9 Global load event configuration for AQCTLB/B2
    vu16 AQCSFRC        : 1; // 10 Global load event configuration for AQCSFRC
    vu16 rsvd1          : 5; // 15:11 Reserved
};
...
{                         // bits description
    vu16 TBPRDLINK   : 4; // 3:0 TBPRD:TBPRDHR  Link
    vu16 CMPALINK    : 4; // 7:4 CMPA:CMPAHR Link
    vu16 CMPBLINK    : 4; // 11:8 CMPB:CMPBHR Link
    vu16 CMPCLINK    : 4; // 15:12 CMPC Link
    vu16 CMPDLINK    : 4; // 19:16 CMPD Link
    vu16 rsvd1       : 8; // 27:20 Reserved
    vu16 GLDCTL2LINK : 4; // 31:28 GLDCTL2 Link
};
...
struct AQCTLA_BITS
{                   // bits description
    vu16 ZRO   : 2; // 1:0 Action Counter = Zero
    vu16 PRD   : 2; // 3:2 Action Counter = Period
    vu16 CAU   : 2; // 5:4 Action Counter = Compare A Up
    vu16 CAD   : 2; // 7:6 Action Counter = Compare A Down
    vu16 CBU   : 2; // 9:8 Action Counter = Compare B Up
    vu16 CBD   : 2; // 11:10 Action Counter = Compare B Down
    vu16 rsvd1 : 4; // 15:12 Reserved
};
...
struct AQCTLA2_BITS
{                   // bits description
    vu16 T1U   : 2; // 1:0 Action when event occurs on T1 in UP-Count
    vu16 T1D   : 2; // 3:2 Action when event occurs on T1 in DOWN-Count
    vu16 T2U   : 2; // 5:4 Action when event occurs on T2 in UP-Count
    vu16 T2D   : 2; // 7:6 Action when event occurs on T2 in DOWN-Count
    vu16 rsvd1 : 8; // 15:8 Reserved
};
...
struct AQSFRC_BITS
{                    // bits description
    vu16 ACTSFA : 2; // 1:0 Action when One-time SW Force A Invoked
    vu16 OTSFA  : 1; // 2 One-time SW Force A Output
    vu16 ACTSFB : 2; // 4:3 Action when One-time SW Force B Invoked
    vu16 OTSFB  : 1; // 5 One-time SW Force A Output
    vu16 RLDCSF : 2; // 7:6 Reload from Shadow Options
    vu16 rsvd1  : 8; // 15:8 Reserved
};
...
struct AQCSFRC_BITS
{                    // bits description
    vu16 CSFA  : 2;  // 1:0 Continuous Software Force on output A
    vu16 CSFB  : 2;  // 3:2 Continuous Software Force on output B
    vu16 rsvd1 : 12; // 15:4 Reserved
};
...
{                     // bits description
    ...
    vu16 rsvd2   : 7; // 7:1 Reserved
    vu16 rsvd3   : 1; // 8 Reserved
    vu16 DBREDHR : 7; // 15:9 DBREDHR High Resolution Bits
};
...
struct DBRED_BITS
{                    // bits description
    vu16 DBRED : 14; // 13:0 Rising edge delay value
    vu16 rsvd1 : 2;  // 15:14 Reserved
};
...
{                     // bits description
    ...
    vu16 rsvd2   : 7; // 7:1 Reserved
    vu16 rsvd3   : 1; // 8 Reserved
    vu16 DBFEDHR : 7; // 15:9 DBFEDHR High Resolution Bits
};
...
struct DBFED_BITS
{                    // bits description
    vu16 DBFED : 14; // 13:0 Falling edge delay value
    vu16 rsvd1 : 2;  // 15:14 Reserved
};
...
struct TBPHS_BITS
{                      // bits description
    vu16 TBPHSHR : 16; // 15:0 Extension Register for HRPWM Phase (8-bits)
    vu16 TBPHS   : 16; // 31:16 Phase Offset Register
};
...
struct CMPA_BITS
{                     // bits description
    vu16 CMPAHR : 16; // 15:0 Compare A HRPWM Extension Register
    vu16 CMPA   : 16; // 31:16 Compare A Register
};
...
struct CMPB_BITS
{                     // bits description
    vu16 CMPBHR : 16; // 15:0 Compare B High Resolution Bits
    vu16 CMPB   : 16; // 31:16 Compare B Register
};
...
struct GLDCTL2_BITS
{                     // bits description
    vu16 OSHTLD : 1;  // 0 Enable reload event in one shot mode
    vu16 GFRCLD : 1;  // 1 Force reload event in one shot mode
...
struct TZSEL_BITS
{                     // bits description
    vu16 CBC1    : 1; // 0 TZ1 CBC select
    vu16 CBC2    : 1; // 1 TZ2 CBC select
    vu16 CBC3    : 1; // 2 TZ3 CBC select
    vu16 CBC4    : 1; // 3 TZ4 CBC select
    vu16 CBC5    : 1; // 4 TZ5 CBC select
    vu16 CBC6    : 1; // 5 TZ6 CBC select
    vu16 DCAEVT2 : 1; // 6 DCAEVT2 CBC select
    vu16 DCBEVT2 : 1; // 7 DCBEVT2 CBC select
    vu16 OSHT1   : 1; // 8 One-shot TZ1 select
    vu16 OSHT2   : 1; // 9 One-shot TZ2 select
    vu16 OSHT3   : 1; // 10 One-shot TZ3 select
    vu16 OSHT4   : 1; // 11 One-shot TZ4 select
    vu16 OSHT5   : 1; // 12 One-shot TZ5 select
    vu16 OSHT6   : 1; // 13 One-shot TZ6 select
    vu16 DCAEVT1 : 1; // 14 One-shot DCAEVT1 select
    vu16 DCBEVT1 : 1; // 15 One-shot DCBEVT1 select
};
...
struct TZDCSEL_BITS
{                     // bits description
    vu16 DCAEVT1 : 3; // 2:0 Digital Compare Output A Event 1
    vu16 DCAEVT2 : 3; // 5:3 Digital Compare Output A Event 2
    vu16 DCBEVT1 : 3; // 8:6 Digital Compare Output B Event 1
    vu16 DCBEVT2 : 3; // 11:9 Digital Compare Output B Event 2
    vu16 rsvd1   : 4; // 15:12 Reserved
};
...
struct TZCTL_BITS
{                     // bits description
    vu16 TZA     : 2; // 1:0 TZ1 to TZ6 Trip Action On EPWMxA
    vu16 TZB     : 2; // 3:2 TZ1 to TZ6 Trip Action On EPWMxB
    vu16 DCAEVT1 : 2; // 5:4 EPWMxA action on DCAEVT1
    vu16 DCAEVT2 : 2; // 7:6 EPWMxA action on DCAEVT2
    vu16 DCBEVT1 : 2; // 9:8 EPWMxB action on DCBEVT1
    vu16 DCBEVT2 : 2; // 11:10 EPWMxB action on DCBEVT2
    vu16 rsvd1   : 4; // 15:12 Reserved
};
...
struct TZCTL2_BITS
{                   // bits description
    vu16 TZAU  : 3; // 2:0 Trip Action On EPWMxA while Count direction is UP
    vu16 TZAD  : 3; // 5:3 Trip Action On EPWMxA while Count direction is DOWN
    vu16 TZBU  : 3; // 8:6 Trip Action On EPWMxB while Count direction is UP
    vu16 TZBD  : 3; // 11:9 Trip Action On EPWMxB while Count direction is DOWN
    vu16 rsvd1 : 3; // 14:12 Reserved
    vu16 ETZE  : 1; // 15 TZCTL2 Enable
};
...
{                      // bits description
    vu16 DCAEVT1U : 3; // 2:0 DCAEVT1 Action On EPWMxA while Count direction is UP
    vu16 DCAEVT1D : 3; // 5:3 DCAEVT1 Action On EPWMxA while Count direction is DOWN
    vu16 DCAEVT2U : 3; // 8:6 DCAEVT2 Action On EPWMxA while Count direction is UP
    vu16 DCAEVT2D : 3; // 11:9 DCAEVT2 Action On EPWMxA while Count direction is DOWN
    vu16 rsvd1    : 4; // 15:12 Reserved
};
...
{                      // bits description
    vu16 DCBEVT1U : 3; // 2:0 DCBEVT1 Action On EPWMxA while Count direction is UP
    vu16 DCBEVT1D : 3; // 5:3 DCBEVT1 Action On EPWMxA while Count direction is DOWN
    vu16 DCBEVT2U : 3; // 8:6 DCBEVT2 Action On EPWMxA while Count direction is UP
    vu16 DCBEVT2D : 3; // 11:9 DCBEVT2 Action On EPWMxA while Count direction is DOWN
    vu16 rsvd1    : 4; // 15:12 Reserved
};
...
{                     // bits description
    vu16 rsvd1   : 1; // 0 Reserved
    vu16 CBC     : 1; // 1 Trip Zones Cycle By Cycle Int Enable
    vu16 OST     : 1; // 2 Trip Zones One Shot Int Enable
    vu16 DCAEVT1 : 1; // 3 Digital Compare A Event 1 Int Enable
    vu16 DCAEVT2 : 1; // 4 Digital Compare A Event 2 Int Enable
    vu16 DCBEVT1 : 1; // 5 Digital Compare B Event 1 Int Enable
    vu16 DCBEVT2 : 1; // 6 Digital Compare B Event 2 Int Enable
    vu16 rsvd2   : 9; // 15:7 Reserved
};
...
struct TZFLG_BITS
{                     // bits description
    vu16 INT     : 1; // 0 Global Int Status Flag
    vu16 CBC     : 1; // 1 Trip Zones Cycle By Cycle Flag
    vu16 OST     : 1; // 2 Trip Zones One Shot Flag
    vu16 DCAEVT1 : 1; // 3 Digital Compare A Event 1 Flag
    vu16 DCAEVT2 : 1; // 4 Digital Compare A Event 2 Flag
    vu16 DCBEVT1 : 1; // 5 Digital Compare B Event 1 Flag
    vu16 DCBEVT2 : 1; // 6 Digital Compare B Event 2 Flag
    vu16 rsvd1   : 9; // 15:7 Reserved
};
...
{                     // bits description
    vu16 CBC1    : 1; // 0 Latched Status Flag for CBC1 Trip Latch
    vu16 CBC2    : 1; // 1 Latched Status Flag for CBC2 Trip Latch
    vu16 CBC3    : 1; // 2 Latched Status Flag for CBC3 Trip Latch
    vu16 CBC4    : 1; // 3 Latched Status Flag for CBC4 Trip Latch
    vu16 CBC5    : 1; // 4 Latched Status Flag for CBC5 Trip Latch
    vu16 CBC6    : 1; // 5 Latched Status Flag for CBC6 Trip Latch
    vu16 DCAEVT2 : 1; // 6 Latched Status Flag for Digital Compare Output A Event 2
    vu16 DCBEVT2 : 1; // 7 Latched Status Flag for Digital Compare Output B Event 2
    vu16 rsvd1   : 8; // 15:8 Reserved
};
...
{                     // bits description
    vu16 OST1    : 1; // 0 Latched Status Flag for OST1 Trip Latch
    vu16 OST2    : 1; // 1 Latched Status Flag for OST2 Trip Latch
    vu16 OST3    : 1; // 2 Latched Status Flag for OST3 Trip Latch
    vu16 OST4    : 1; // 3 Latched Status Flag for OST4 Trip Latch
    vu16 OST5    : 1; // 4 Latched Status Flag for OST5 Trip Latch
    vu16 OST6    : 1; // 5 Latched Status Flag for OST6 Trip Latch
    vu16 DCAEVT1 : 1; // 6 Latched Status Flag for Digital Compare Output A Event 1
    vu16 DCBEVT1 : 1; // 7 Latched Status Flag for Digital Compare Output B Event 1
    vu16 rsvd1   : 8; // 15:8 Reserved
};
...
{                      // bits description
    ...
    vu16 CBC      : 1; // 1 Cycle-By-Cycle Flag Clear
    vu16 OST      : 1; // 2 One-Shot Flag Clear
    vu16 DCAEVT1  : 1; // 3 DCAVET1 Flag Clear
    vu16 DCAEVT2  : 1; // 4 DCAEVT2 Flag Clear
    vu16 DCBEVT1  : 1; // 5 DCBEVT1 Flag Clear
    vu16 DCBEVT2  : 1; // 6 DCBEVT2 Flag Clear
    vu16 rsvd1    : 7; // 13:7 Reserved
    vu16 CBCPULSE : 2; // 15:14 Clear Pulse for CBC Trip Latch
};
...
{                     // bits description
    vu16 CBC1    : 1; // 0 Clear Flag for Cycle-By-Cycle (CBC1) Trip Latch
    vu16 CBC2    : 1; // 1 Clear Flag for Cycle-By-Cycle (CBC2) Trip Latch
    vu16 CBC3    : 1; // 2 Clear Flag for Cycle-By-Cycle (CBC3) Trip Latch
    vu16 CBC4    : 1; // 3 Clear Flag for Cycle-By-Cycle (CBC4) Trip Latch
    vu16 CBC5    : 1; // 4 Clear Flag for Cycle-By-Cycle (CBC5) Trip Latch
    vu16 CBC6    : 1; // 5 Clear Flag for Cycle-By-Cycle (CBC6) Trip Latch
    vu16 DCAEVT2 : 1; // 6 Clear Flag forDCAEVT2 selected for CBC
    vu16 DCBEVT2 : 1; // 7 Clear Flag for DCBEVT2 selected for CBC
    vu16 rsvd1   : 8; // 15:8 Reserved
};
...
{                     // bits description
    vu16 OST1    : 1; // 0 Clear Flag for Oneshot (OST1) Trip Latch
    vu16 OST2    : 1; // 1 Clear Flag for Oneshot (OST2) Trip Latch
    vu16 OST3    : 1; // 2 Clear Flag for Oneshot (OST3) Trip Latch
    vu16 OST4    : 1; // 3 Clear Flag for Oneshot (OST4) Trip Latch
    vu16 OST5    : 1; // 4 Clear Flag for Oneshot (OST5) Trip Latch
    vu16 OST6    : 1; // 5 Clear Flag for Oneshot (OST6) Trip Latch
    vu16 DCAEVT1 : 1; // 6 Clear Flag for DCAEVT1 selected for OST
    vu16 DCBEVT1 : 1; // 7 Clear Flag for DCBEVT1 selected for OST
    vu16 rsvd1   : 8; // 15:8 Reserved
};
...
{                     // bits description
    vu16 rsvd1   : 1; // 0 Reserved
    vu16 CBC     : 1; // 1 Force Trip Zones Cycle By Cycle Event
    vu16 OST     : 1; // 2 Force Trip Zones One Shot Event
    vu16 DCAEVT1 : 1; // 3 Force Digital Compare A Event 1
    vu16 DCAEVT2 : 1; // 4 Force Digital Compare A Event 2
    vu16 DCBEVT1 : 1; // 5 Force Digital Compare B Event 1
    vu16 DCBEVT2 : 1; // 6 Force Digital Compare B Event 2
    vu16 rsvd2   : 9; // 15:7 Reserved
};
...
struct ETSEL_BITS
{                        // bits description
    vu16 INTSEL     : 3; // 2:0 EPWMxINTn Select
    vu16 INTEN      : 1; // 3 EPWMxINTn Enable
    vu16 SOCASELCMP : 1; // 4 EPWMxSOCA Compare Select
    vu16 SOCBSELCMP : 1; // 5 EPWMxSOCB Compare Select
    vu16 INTSELCMP  : 1; // 6 EPWMxINT Compare Select
    vu16 rsvd1      : 1; // 7 Reserved
    vu16 SOCASEL    : 3; // 10:8 Start of Conversion A Select
    vu16 SOCAEN     : 1; // 11 Start of Conversion A Enable
    vu16 SOCBSEL    : 3; // 14:12 Start of Conversion B Select
    vu16 SOCBEN     : 1; // 15 Start of Conversion B Enable
};
...
struct ETPS_BITS
{                      // bits description
    vu16 INTPRD   : 2; // 1:0 EPWMxINTn Period Select
    vu16 INTCNT   : 2; // 3:2 EPWMxINTn Counter Register
    vu16 INTPSSEL : 1; // 4 EPWMxINTn Pre-Scale Selection Bits
    vu16 SOCPSSEL : 1; // 5 EPWMxSOC A/B  Pre-Scale Selection Bits
    vu16 rsvd1    : 2; // 7:6 Reserved
    vu16 SOCAPRD  : 2; // 9:8 EPWMxSOCA Period Select
    vu16 SOCACNT  : 2; // 11:10 EPWMxSOCA Counter Register
    vu16 SOCBPRD  : 2; // 13:12 EPWMxSOCB Period Select
    vu16 SOCBCNT  : 2; // 15:14 EPWMxSOCB Counter
};
...
struct ETFLG_BITS
{                    // bits description
    vu16 INT   : 1;  // 0 EPWMxINTn Flag
    vu16 rsvd1 : 1;  // 1 Reserved
    vu16 SOCA  : 1;  // 2 EPWMxSOCA Flag
    vu16 SOCB  : 1;  // 3 EPWMxSOCB Flag
    vu16 rsvd2 : 12; // 15:4 Reserved
};
...
struct ETCLR_BITS
{                    // bits description
    vu16 INT   : 1;  // 0 EPWMxINTn Clear
    vu16 rsvd1 : 1;  // 1 Reserved
    vu16 SOCA  : 1;  // 2 EPWMxSOCA Clear
    vu16 SOCB  : 1;  // 3 EPWMxSOCB Clear
    vu16 rsvd2 : 12; // 15:4 Reserved
};
...
struct ETFRC_BITS
{                    // bits description
    vu16 INT   : 1;  // 0 EPWMxINTn Force
    vu16 rsvd1 : 1;  // 1 Reserved
    vu16 SOCA  : 1;  // 2 EPWMxSOCA Force
    vu16 SOCB  : 1;  // 3 EPWMxSOCB Force
    vu16 rsvd2 : 12; // 15:4 Reserved
};
...
struct ETINTPS_BITS
{                     // bits description
    vu16 INTPRD2 : 4; // 3:0 EPWMxINTn Period Select
    vu16 INTCNT2 : 4; // 7:4 EPWMxINTn Counter Register
    vu16 rsvd1   : 8; // 15:8 Reserved
};
...
struct ETSOCPS_BITS
{                      // bits description
    vu16 SOCAPRD2 : 4; // 3:0 EPWMxSOCA Period Select
    vu16 SOCACNT2 : 4; // 7:4 EPWMxSOCA Counter Register
    vu16 SOCBPRD2 : 4; // 11:8 EPWMxSOCB Period Select
    vu16 SOCBCNT2 : 4; // 15:12 EPWMxSOCB Counter Register
};
...
{                          // bits description
    ...
    vu16 INTINITFRC  : 1;  // 10 EPWMxINT Counter Initialization Force
    vu16 SOCAINITFRC : 1;  // 11 EPWMxSOCA Counter Initialization Force
    vu16 SOCBINITFRC : 1;  // 12 EPWMxSOCB Counter Initialization Force
    vu16 INTINITEN   : 1;  // 13 EPWMxINT Counter Initialization Enable
    vu16 SOCAINITEN  : 1;  // 14 EPWMxSOCA Counter Initialization Enable
    vu16 SOCBINITEN  : 1;  // 15 EPWMxSOCB Counter Initialization Enable
};
...
{                      // bits description
    vu16 INTINIT  : 4; // 3:0 EPWMxINT Counter Initialization Bits
    vu16 SOCAINIT : 4; // 7:4 EPWMxSOCA Counter Initialization Bits
    vu16 SOCBINIT : 4; // 11:8 EPWMxSOCB Counter Initialization Bits
    vu16 rsvd1    : 4; // 15:12 Reserved
};
...
{                         // bits description
    vu16 DCAHCOMPSEL : 4; // 3:0 Digital Compare A High COMP Input Select
    vu16 DCALCOMPSEL : 4; // 7:4 Digital Compare A Low COMP Input Select
    vu16 DCBHCOMPSEL : 4; // 11:8 Digital Compare B High COMP Input Select
    vu16 DCBLCOMPSEL : 4; // 15:12 Digital Compare B Low COMP Input Select
};
...
struct DCACTL_BITS
{                            // bits description
    vu16 EVT1SRCSEL     : 1; // 0 DCAEVT1 Source Signal
    vu16 EVT1FRCSYNCSEL : 1; // 1 DCAEVT1 Force Sync Signal
    vu16 EVT1SOCE       : 1; // 2 DCAEVT1 SOC Enable
    vu16 EVT1SYNCE      : 1; // 3 DCAEVT1 SYNC Enable
    vu16 rsvd1          : 4; // 7:4 Reserved
    vu16 EVT2SRCSEL     : 1; // 8 DCAEVT2 Source Signal
    vu16 EVT2FRCSYNCSEL : 1; // 9 DCAEVT2 Force Sync Signal
    vu16 rsvd2          : 6; // 15:10 Reserved
};
...
struct DCBCTL_BITS
{                            // bits description
    vu16 EVT1SRCSEL     : 1; // 0 DCBEVT1 Source Signal
    vu16 EVT1FRCSYNCSEL : 1; // 1 DCBEVT1 Force Sync Signal
    vu16 EVT1SOCE       : 1; // 2 DCBEVT1 SOC Enable
    vu16 EVT1SYNCE      : 1; // 3 DCBEVT1 SYNC Enable
    vu16 rsvd1          : 4; // 7:4 Reserved
    vu16 EVT2SRCSEL     : 1; // 8 DCBEVT2 Source Signal
    vu16 EVT2FRCSYNCSEL : 1; // 9 DCBEVT2 Force Sync Signal
    vu16 rsvd2          : 6; // 15:10 Reserved
};
...
struct DCFCTL_BITS
{                         // bits description
    vu16 SRCSEL      : 2; // 1:0 Filter Block Signal Source Select
    vu16 BLANKE      : 1; // 2 Blanking Enable/Disable
    vu16 BLANKINV    : 1; // 3 Blanking Window Inversion
    vu16 PULSESEL    : 2; // 5:4 Pulse Select for Blanking & Capture Alignment
    vu16 EDGEFILTSEL : 1; // 6 Edge Filter Select
    vu16 rsvd1       : 1; // 7 Reserved
    vu16 EDGEMODE    : 2; // 9:8 Edge Mode
    vu16 EDGECOUNT   : 3; // 12:10 Edge Count
    vu16 EDGESTATUS  : 3; // 15:13 Edge Status
};
...
{                       // bits description
    vu16 CAPE     : 1;  // 0 Counter Capture Enable
    vu16 SHDWMODE : 1;  // 1 Counter Capture Mode
    vu16 rsvd1    : 11; // 12:2 Reserved
    vu16 CAPSTS   : 1;  // 13 Latched Status Flag for Capture Event
    vu16 CAPCLR   : 1;  // 14 DC Capture Latched Status Clear Flag
    vu16 CAPMODE  : 1;  // 15 Counter Capture Mode
};
...
{                         // bits description
    vu16 TRIPINPUT1  : 1; // 0 Trip Input 1 Select to DCAH Mux
    vu16 TRIPINPUT2  : 1; // 1 Trip Input 2 Select to DCAH Mux
    vu16 TRIPINPUT3  : 1; // 2 Trip Input 3 Select to DCAH Mux
    vu16 TRIPINPUT4  : 1; // 3 Trip Input 4 Select to DCAH Mux
    vu16 TRIPINPUT5  : 1; // 4 Trip Input 5 Select to DCAH Mux
    vu16 TRIPINPUT6  : 1; // 5 Trip Input 6 Select to DCAH Mux
    vu16 TRIPINPUT7  : 1; // 6 Trip Input 7 Select to DCAH Mux
    vu16 TRIPINPUT8  : 1; // 7 Trip Input 8 Select to DCAH Mux
    vu16 TRIPINPUT9  : 1; // 8 Trip Input 9 Select to DCAH Mux
    vu16 TRIPINPUT10 : 1; // 9 Trip Input 10 Select to DCAH Mux
    vu16 TRIPINPUT11 : 1; // 10 Trip Input 11 Select to DCAH Mux
    vu16 TRIPINPUT12 : 1; // 11 Trip Input 12 Select to DCAH Mux
    vu16 rsvd1       : 1; // 12 Reserved
    vu16 TRIPINPUT14 : 1; // 13 Trip Input 14 Select to DCAH Mux
    vu16 TRIPINPUT15 : 1; // 14 Trip Input 15 Select to DCAH Mux
    vu16 rsvd2       : 1; // 15 Reserved
};
...
{                         // bits description
    vu16 TRIPINPUT1  : 1; // 0 Trip Input 1 Select to DCAL Mux
    vu16 TRIPINPUT2  : 1; // 1 Trip Input 2 Select to DCAL Mux
    vu16 TRIPINPUT3  : 1; // 2 Trip Input 3 Select to DCAL Mux
    vu16 TRIPINPUT4  : 1; // 3 Trip Input 4 Select to DCAL Mux
    vu16 TRIPINPUT5  : 1; // 4 Trip Input 5 Select to DCAL Mux
    vu16 TRIPINPUT6  : 1; // 5 Trip Input 6 Select to DCAL Mux
    vu16 TRIPINPUT7  : 1; // 6 Trip Input 7 Select to DCAL Mux
    vu16 TRIPINPUT8  : 1; // 7 Trip Input 8 Select to DCAL Mux
    vu16 TRIPINPUT9  : 1; // 8 Trip Input 9 Select to DCAL Mux
    vu16 TRIPINPUT10 : 1; // 9 Trip Input 10 Select to DCAL Mux
    vu16 TRIPINPUT11 : 1; // 10 Trip Input 11 Select to DCAL Mux
    vu16 TRIPINPUT12 : 1; // 11 Trip Input 12 Select to DCAL Mux
    vu16 rsvd1       : 1; // 12 Reserved
    vu16 TRIPINPUT14 : 1; // 13 Trip Input 14 Select to DCAL Mux
    vu16 TRIPINPUT15 : 1; // 14 Trip Input 15 Select to DCAL Mux
    vu16 rsvd2       : 1; // 15 Reserved
};
...
{                         // bits description
    vu16 TRIPINPUT1  : 1; // 0 Trip Input 1 Select to DCBH Mux
    vu16 TRIPINPUT2  : 1; // 1 Trip Input 2 Select to DCBH Mux
    vu16 TRIPINPUT3  : 1; // 2 Trip Input 3 Select to DCBH Mux
    vu16 TRIPINPUT4  : 1; // 3 Trip Input 4 Select to DCBH Mux
    vu16 TRIPINPUT5  : 1; // 4 Trip Input 5 Select to DCBH Mux
    vu16 TRIPINPUT6  : 1; // 5 Trip Input 6 Select to DCBH Mux
    vu16 TRIPINPUT7  : 1; // 6 Trip Input 7 Select to DCBH Mux
    vu16 TRIPINPUT8  : 1; // 7 Trip Input 8 Select to DCBH Mux
    vu16 TRIPINPUT9  : 1; // 8 Trip Input 9 Select to DCBH Mux
    vu16 TRIPINPUT10 : 1; // 9 Trip Input 10 Select to DCBH Mux
    vu16 TRIPINPUT11 : 1; // 10 Trip Input 11 Select to DCBH Mux
    vu16 TRIPINPUT12 : 1; // 11 Trip Input 12 Select to DCBH Mux
    vu16 rsvd1       : 1; // 12 Reserved
    vu16 TRIPINPUT14 : 1; // 13 Trip Input 14 Select to DCBH Mux
    vu16 TRIPINPUT15 : 1; // 14 Trip Input 15 Select to DCBH Mux
    vu16 rsvd2       : 1; // 15 Reserved
};
...
{                         // bits description
    vu16 TRIPINPUT1  : 1; // 0 Trip Input 1 Select to DCBL Mux
    vu16 TRIPINPUT2  : 1; // 1 Trip Input 2 Select to DCBL Mux
    vu16 TRIPINPUT3  : 1; // 2 Trip Input 3 Select to DCBL Mux
    vu16 TRIPINPUT4  : 1; // 3 Trip Input 4 Select to DCBL Mux
    vu16 TRIPINPUT5  : 1; // 4 Trip Input 5 Select to DCBL Mux
    vu16 TRIPINPUT6  : 1; // 5 Trip Input 6 Select to DCBL Mux
    vu16 TRIPINPUT7  : 1; // 6 Trip Input 7 Select to DCBL Mux
    vu16 TRIPINPUT8  : 1; // 7 Trip Input 8 Select to DCBL Mux
    vu16 TRIPINPUT9  : 1; // 8 Trip Input 9 Select to DCBL Mux
    vu16 TRIPINPUT10 : 1; // 9 Trip Input 10 Select to DCBL Mux
    vu16 TRIPINPUT11 : 1; // 10 Trip Input 11 Select to DCBL Mux
    vu16 TRIPINPUT12 : 1; // 11 Trip Input 12 Select to DCBL Mux
    vu16 rsvd1       : 1; // 12 Reserved
    vu16 TRIPINPUT14 : 1; // 13 Trip Input 14 Select to DCBL Mux
    vu16 TRIPINPUT15 : 1; // 14 Trip Input 15 Select to DCBL Mux
    vu16 rsvd2       : 1; // 15 Reserved
};
...
struct EPWMLOCK_BITS
{                        // bits description
    vu16 HRLOCK    : 1;  // 0 HRPWM Register Set Lock
    vu16 GLLOCK    : 1;  // 1 Global Load Register Set Lock
    vu16 TZCFGLOCK : 1;  // 2 TripZone Register Set Lock
    vu16 TZCLRLOCK : 1;  // 3 TripZone Clear Register Set Lock
    vu16 DCLOCK    : 1;  // 4 Digital Compare Register Set Lock
    vu16 rsvd1     : 11; // 15:5 Reserved
    vu16 KEY       : 16; // 31:16 Key to write to this register
};
...
struct EPWM_REGS
{
    ...
    vu16 rsvd16[12];                     // Reserved
    union TBPHS_REG TBPHS;               // Time Base Phase High
    vu16 TBPRDHR;                        // Time Base Period High Resolution Register
    vu16 TBPRD;                          // Time Base Period Register
    vu16 rsvd17[6];                      // Reserved
    union CMPA_REG CMPA;                 // Counter Compare A Register
    union CMPB_REG CMPB;                 // Compare B Register
    vu16 rsvd18;                         // Reserved
    vu16 CMPC;                           // Counter Compare C Register
    vu16 rsvd19;                         // Reserved
    vu16 CMPD;                           // Counter Compare D Register
    vu16 rsvd20[2];                      // Reserved
    union GLDCTL2_REG GLDCTL2;           // Global PWM Load Control Register 2
    vu16 rsvd21[2];                      // Reserved
    vu16 SWVDELVAL;                      // Software Valley Mode Delay Register
    vu16 rsvd22[8];                      // Reserved
    union TZSEL_REG TZSEL;               // Trip Zone Select Register
    vu16 rsvd23;                         // Reserved
    union TZDCSEL_REG TZDCSEL;           // Trip Zone Digital Comparator Select Register
    vu16 rsvd24;                         // Reserved
    ...
    vu16 DCFOFFSET;                      // Digital Compare Filter Offset Register
    vu16 DCFOFFSETCNT;                   // Digital Compare Filter Offset Counter Register
    vu16 DCFWINDOW;                      // Digital Compare Filter Window Register
    vu16 DCFWINDOWCNT;                   // Digital Compare Filter Window Counter Register
    vu16 rsvd41[2];                      // Reserved
    vu16 DCCAP;                          // Digital Compare Counter Capture Register
    vu16 rsvd42[2];                      // Reserved
    ...
    vu16 rsvd43[36];                     // Reserved
    union EPWMLOCK_REG EPWMLOCK;         // EPWM Lock Register
    vu16 rsvd44;                         // Reserved
    vu16 HWVDELVAL;                      // Hardware Valley Mode Delay Register
    vu16 VCNTVAL;                        // Hardware Valley Counter Register
};

struct HRCAL_BITS
{
    vu32 HRMSTEP_TEMP : 8;  // 7:0
    vu32 rsvd1        : 20; // 27:8
    vu32 CAL_DONE     : 1;  // 28
    vu32 SAMPLE_VALID : 1;  // 29
    vu32 SAMPLE_EN    : 1;  // 30
    vu32 CAL_EN       : 1;  // 31
};
...
{
    vu32 all;
    struct HRCAL_BITS bit;
};

struct HRCAL_REGS
{
    vu16 rsvd1[36];
    union HRCAL_REG HRCAL;
};

#define EPwm1Regs ((struct EPWM_REGS *)EPWM1_BASE)
#define EPwm2Regs ((struct EPWM_REGS *)EPWM2_BASE)
#define EPwm3Regs ((struct EPWM_REGS *)EPWM3_BASE)
#define EPwm4Regs ((struct EPWM_REGS *)EPWM4_BASE)
#define EPwm5Regs ((struct EPWM_REGS *)EPWM5_BASE)
#define EPwm6Regs ((struct EPWM_REGS *)EPWM6_BASE)
#define EPwm7Regs ((struct EPWM_REGS *)EPWM7_BASE)
#define EPwm8Regs ((struct EPWM_REGS *)EPWM8_BASE)
#define HRCALRegs ((struct HRCAL_REGS *)SFO_BASE)
...
{
    return ((base == EPWM1_BASE) || (base == EPWM2_BASE) || (base == EPWM3_BASE) || (base == EPWM4_BASE)
            || (base == EPWM5_BASE) || (base == EPWM6_BASE) || (base == EPWM7_BASE) || (base == EPWM8_BASE));
}
#endif
...
//
//*****************************************************************************
static inline void EPWM_setCountModeAfterSync(uint32_t base, EPWM_SyncCountMode mode)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setClockPrescaler(
    uint32_t base, EPWM_ClockDivider prescaler, EPWM_HSClockDivider highSpeedPrescaler)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setSyncOutPulseMode(uint32_t base, EPWM_SyncOutPulseMode mode)
{
    //
    // Check the arguments
    //
    ...
    if (mode < EPWM_SYNC_OUT_PULSE_DISABLED)
    {
        ...
        HWREGH(base + EPWM_O_TBCTL)
            = ((HWREGH(base + EPWM_O_TBCTL) & ~(EPWM_TBCTL_SYNCOSEL_M)) | ((uint16_t)mode << EPWM_TBCTL_SYNCOSEL_S));
    }
    //
    ...
    else
    {
        ...
        //
        HWREGH(base + EPWM_O_TBCTL) = HWREGH(base + EPWM_O_TBCTL) | EPWM_TBCTL_SYNCOSEL_M;

        //
        // Write to SYNCOSELX bit
        //
        HWREGH(base + EPWM_O_TBCTL2) = ((HWREGH(base + EPWM_O_TBCTL2) & ~(EPWM_TBCTL2_SYNCOSELX_M))
...
//
//*****************************************************************************
static inline void EPWM_setPeriodLoadMode(uint32_t base, EPWM_PeriodLoadMode loadMode)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setTimeBaseCounterMode(uint32_t base, EPWM_TimeBaseCountMode counterMode)
{
    //
    // Check the arguments
    //
    ...
    //
    HWREGH(base + EPWM_O_TBCTL) = ((HWREGH(base + EPWM_O_TBCTL) & ~(EPWM_TBCTL_CTRMODE_M)) | ((uint16_t)counterMode));
}
...
//
//*****************************************************************************
static inline void EPWM_selectPeriodLoadEvent(uint32_t base, EPWM_PeriodShadowLoadMode shadowLoadMode)
{
    //
    // Check the arguments
    //
...
static inline bool EPWM_getTimeBaseCounterOverflowStatus(uint32_t base)
{
    ...
    //
    return (((HWREGH(base + EPWM_O_TBSTS) & EPWM_TBSTS_CTRMAX) == EPWM_TBSTS_CTRMAX) ? true : false);
}
...
static inline bool EPWM_getSyncStatus(uint32_t base)
{
    ...
    //
    return (((HWREGH(base + EPWM_O_TBSTS) & EPWM_TBSTS_SYNCI) == EPWM_TBSTS_SYNCI) ? true : false);
}
...
static inline void EPWM_setPhaseShift(uint32_t base, uint16_t phaseCount)
{
    ...
    // Write to TBPHS bit
    //
    HWREG(base + EPWM_O_TBPHS) = ((HWREG(base + EPWM_O_TBPHS) & ~((uint32_t)EPWM_TBPHS_TBPHS_M))
...
//
//*****************************************************************************
static inline void EPWM_setupEPWMLinks(uint32_t base, EPWM_CurrentLink epwmLink, EPWM_LinkComponent linkComp)
{
    //
    // Check the arguments
    //
    ...
    HWREG(base + EPWM_O_XLINK)
        = ((HWREG(base + EPWM_O_XLINK) & ~((uint32_t)0xFU << linkComp)) | ((uint32_t)epwmLink << linkComp));
}
...
//
//*****************************************************************************
static inline void EPWM_setCounterCompareShadowLoadMode(
    uint32_t base, EPWM_CounterCompareModule compModule, EPWM_CounterCompareLoadMode loadMode)
{
    ...
    //
    registerOffset = base + EPWM_O_CMPCTL + ((uint32_t)compModule & 0b11);
    ...
    HWREGH(registerOffset)
        = ((HWREGH(registerOffset)
            ...
            | // shadow mode
            ((((uint16_t)loadMode >> 2U) << syncModeOffset) | (((uint16_t)loadMode & 0x3U) << loadModeOffset)));
}
...
//
//*****************************************************************************
static inline void EPWM_disableCounterCompareShadowLoadMode(uint32_t base, EPWM_CounterCompareModule compModule)
{
    uint16_t shadowModeOffset;
    uint32_t registerOffset;
    ...
    //
    HWREGH(registerOffset) = (HWREGH(registerOffset) | (0x1U << shadowModeOffset));
}
...
//
//*****************************************************************************
static inline uint16_t EPWM_getCounterCompareValue(uint32_t base, EPWM_CounterCompareModule compModule)
{
    uint32_t registerOffset;
    uint16_t compCount;
    ...
    if ((compModule == EPWM_COUNTER_COMPARE_A) || (compModule == EPWM_COUNTER_COMPARE_B))
    {
        ...
        //
        compCount = (uint16_t)((HWREG(base + registerOffset) & (uint32_t)0xFFFF0000U) >> 16U);
    }
    else
    {
        //
...
//
//*****************************************************************************
static inline bool EPWM_getCounterCompareShadowStatus(uint32_t base, EPWM_CounterCompareModule compModule)
{
    //
    // Check the arguments
    //
    ...
    //
    return ((((HWREG(base + EPWM_O_CMPCTL) >> ((((uint16_t)compModule >> 1U) & 0x1U) + 8U)) & 0x1U) == 0x1U) ? true
                                                                                                             : false);
}
...
//
//*****************************************************************************
static inline void EPWM_setActionQualifierShadowLoadMode(
    uint32_t base, EPWM_ActionQualifierModule aqModule, EPWM_ActionQualifierLoadMode loadMode)
{
    uint16_t syncModeOffset;
    uint16_t shadowModeOffset;
    ...
    HWREGH(base + EPWM_O_AQCTL)
        = ((HWREGH(base + EPWM_O_AQCTL) & (~((0x3U << (uint16_t)aqModule) | (0x3U << (uint16_t)syncModeOffset)))
               | (0x1U << shadowModeOffset))
...
//
//*****************************************************************************
static inline void EPWM_disableActionQualifierShadowLoadMode(uint32_t base, EPWM_ActionQualifierModule aqModule)
{
    uint16_t shadowModeOffset;
...
//
//*****************************************************************************
static inline void EPWM_setActionQualifierT1TriggerSource(uint32_t base, EPWM_ActionQualifierTriggerSource trigger)
{
    //
    // Check the arguments
    //
    ...
    HWREGH(base + EPWM_O_AQTSRCSEL)
        = ((HWREGH(base + EPWM_O_AQTSRCSEL) & (~EPWM_AQTSRCSEL_T1SEL_M)) | ((uint16_t)trigger));
}
...
//
//*****************************************************************************
static inline void EPWM_setActionQualifierT2TriggerSource(uint32_t base, EPWM_ActionQualifierTriggerSource trigger)
{
    //
    // Check the arguments
    //
    ...
    //
    HWREGH(base + EPWM_O_AQTSRCSEL) = ((HWREGH(base + EPWM_O_AQTSRCSEL) & (~EPWM_AQTSRCSEL_T2SEL_M))
...
//
//*****************************************************************************
static inline void EPWM_setActionQualifierAction(uint32_t base, EPWM_ActionQualifierOutputModule epwmOutput,
    EPWM_ActionQualifierOutput output, EPWM_ActionQualifierOutputEvent event)
{
    ...
    if (((uint16_t)event & 0x1U) == 1U)
    {
        ...
        //
        HWREGH(base + registerTOffset) = ((HWREGH(base + registerTOffset) & ~(3U << ((uint16_t)event - 1U)))
    ...
    else
    {
        ...
        HWREGH(base + registerOffset)
            = ((HWREGH(base + registerOffset) & ~(3U << (uint16_t)event)) | ((uint16_t)output << (uint16_t)event));
    }
}
...
static inline void EPWM_setActionQualifierActionComplete(
    uint32_t base, EPWM_ActionQualifierOutputModule epwmOutput, uint16_t action)
{
    uint32_t registerOffset;
...
//
//*****************************************************************************
static inline void EPWM_setActionQualifierContSWForceShadowMode(uint32_t base, EPWM_ActionQualifierContForce mode)
{
    //
    // Check the arguments
    //
    ...
    HWREGH(base + EPWM_O_AQSFRC)
        = ((HWREGH(base + EPWM_O_AQSFRC) & ~EPWM_AQSFRC_RLDCSF_M) | ((uint16_t)mode << EPWM_AQSFRC_RLDCSF_S));
}
...
static inline void EPWM_setActionQualifierContSWForceAction(
    uint32_t base, EPWM_ActionQualifierOutputModule epwmOutput, EPWM_ActionQualifierSWOutput output)
{
    //
    // Check the arguments
    //
    ...
    {
        HWREGH(base + EPWM_O_AQCSFRC) = ((HWREGH(base + EPWM_O_AQCSFRC) & ~EPWM_AQCSFRC_CSFA_M) | ((uint16_t)output));
    }
    else
    {
        HWREGH(base + EPWM_O_AQCSFRC)
            = ((HWREGH(base + EPWM_O_AQCSFRC) & ~EPWM_AQCSFRC_CSFB_M) | ((uint16_t)output << EPWM_AQCSFRC_CSFB_S));
    }
}
...
static inline void EPWM_setActionQualifierSWAction(
    uint32_t base, EPWM_ActionQualifierOutputModule epwmOutput, EPWM_ActionQualifierOutput output)
{
    //
    // Check the arguments
    //
    ...
    if (epwmOutput == EPWM_AQ_OUTPUT_A)
    {
        HWREGH(base + EPWM_O_AQSFRC) = ((HWREGH(base + EPWM_O_AQSFRC) & ~EPWM_AQSFRC_ACTSFA_M) | ((uint16_t)output));
    }
    else
    {
        HWREGH(base + EPWM_O_AQSFRC)
            = ((HWREGH(base + EPWM_O_AQSFRC) & ~EPWM_AQSFRC_ACTSFB_M) | ((uint16_t)output << EPWM_AQSFRC_ACTSFB_S));
    }
}
...
//
//*****************************************************************************
static inline void EPWM_forceActionQualifierSWAction(uint32_t base, EPWM_ActionQualifierOutputModule epwmOutput)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setDeadBandOutputSwapMode(uint32_t base, EPWM_DeadBandOutput output, bool enableSwapMode)
{
    uint16_t mask;
...
//
//*****************************************************************************
static inline void EPWM_setDeadBandDelayMode(uint32_t base, EPWM_DeadBandDelayMode delayMode, bool enableDelayMode)
{
    uint16_t mask;
...
//
//*****************************************************************************
static inline void EPWM_setDeadBandDelayPolarity(
    uint32_t base, EPWM_DeadBandDelayMode delayMode, EPWM_DeadBandPolarity polarity)
{
    uint16_t shift;
    ...
    //
    HWREGH(base + EPWM_O_DBCTL) = ((HWREGH(base + EPWM_O_DBCTL) & ~(1U << shift)) | ((uint16_t)polarity << shift));
}
...
//
//*****************************************************************************
static inline void EPWM_setRisingEdgeDeadBandDelayInput(uint32_t base, uint16_t input)
{
    //
    // Check the arguments
    //
    ...
    HWREGH(base + EPWM_O_DBCTL)
        = ((HWREGH(base + EPWM_O_DBCTL) & ~(1U << (EPWM_DBCTL_IN_MODE_S))) | (input << EPWM_DBCTL_IN_MODE_S));
}
...
//
//*****************************************************************************
static inline void EPWM_setFallingEdgeDeadBandDelayInput(uint32_t base, uint16_t input)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setDeadBandControlShadowLoadMode(uint32_t base, EPWM_DeadBandControlLoadMode loadMode)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setRisingEdgeDelayCountShadowLoadMode(uint32_t base, EPWM_RisingEdgeDelayLoadMode loadMode)
{
    //
    // Check the arguments
    //
    ...
    HWREGH(base + EPWM_O_DBCTL)
        = ((HWREGH(base + EPWM_O_DBCTL) & ~EPWM_DBCTL_LOADREDMODE_M)
            | ((uint16_t)EPWM_DBCTL_SHDWDBREDMODE | ((uint16_t)loadMode << EPWM_DBCTL_LOADREDMODE_S)));
}
...
//
//*****************************************************************************
static inline void EPWM_disableRisingEdgeDelayCountShadowLoadMode(uint32_t base)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setFallingEdgeDelayCountShadowLoadMode(uint32_t base, EPWM_FallingEdgeDelayLoadMode loadMode)
{
    //
    // Check the arguments
    //
    ...
    HWREGH(base + EPWM_O_DBCTL) = ((HWREGH(base + EPWM_O_DBCTL) & ~EPWM_DBCTL_LOADFEDMODE_M)
                                   | (EPWM_DBCTL_SHDWDBFEDMODE | ((uint16_t)loadMode << EPWM_DBCTL_LOADFEDMODE_S)));
}
...
//
//*****************************************************************************
static inline void EPWM_disableFallingEdgeDelayCountShadowLoadMode(uint32_t base)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setDeadBandCounterClock(uint32_t base, EPWM_DeadBandClockMode clockMode)
{
    //
    // Check the arguments
    //
    ...
    //
    HWREGH(base + EPWM_O_DBCTL)
        = ((HWREGH(base + EPWM_O_DBCTL) & ~EPWM_DBCTL_HALFCYCLE) | ((uint16_t)clockMode << 15U));
}
...
//
//*****************************************************************************
static inline void EPWM_setRisingEdgeDelayCount(uint32_t base, uint16_t redCount)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setFallingEdgeDelayCount(uint32_t base, uint16_t fedCount)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setChopperDutyCycle(uint32_t base, uint16_t dutyCycleCount)
{
    //
    // Check the arguments
    //
...
static inline void EPWM_setChopperFreq(uint32_t base, uint16_t freqDiv)
{
    ...
    //
    HWREGH(base + EPWM_O_PCCTL)
        = ((HWREGH(base + EPWM_O_PCCTL) & ~(uint16_t)EPWM_PCCTL_CHPFREQ_M) | (freqDiv << EPWM_PCCTL_CHPFREQ_S));
}
...
//
//*****************************************************************************
static inline void EPWM_setChopperFirstPulseWidth(uint32_t base, uint16_t firstPulseWidth)
{
    //
    // Check the arguments
    //
    ...
    //
    HWREGH(base + EPWM_O_PCCTL)
        = ((HWREGH(base + EPWM_O_PCCTL) & ~(uint16_t)EPWM_PCCTL_OSHTWTH_M) | (firstPulseWidth << EPWM_PCCTL_OSHTWTH_S));
}
...
//
//*****************************************************************************
static inline void EPWM_disableTripZoneSignals(uint32_t base, uint16_t tzSignal)
{
    //
    // Check the arguments
    //
...
static inline void EPWM_setTripZoneDigitalCompareEventCondition(
    uint32_t base, EPWM_TripZoneDigitalCompareOutput dcType, EPWM_TripZoneDigitalCompareOutputEvent dcEvent)
{
    //
    // Check the arguments
    //
    ...
    HWREGH(base + EPWM_O_TZDCSEL)
        = ((HWREGH(base + EPWM_O_TZDCSEL) & ~(0x7U << (uint16_t)dcType)) | ((uint16_t)dcEvent << (uint16_t)dcType));
    EDIS;
}
...
//
//*****************************************************************************
static inline void EPWM_setTripZoneAction(uint32_t base, EPWM_TripZoneEvent tzEvent, EPWM_TripZoneAction tzAction)
{
    //
    // Check the arguments
    //
    ...
    HWREGH(base + EPWM_O_TZCTL)
        = ((HWREGH(base + EPWM_O_TZCTL) & ~(0x3U << (uint16_t)tzEvent)) | ((uint16_t)tzAction << (uint16_t)tzEvent));
    EDIS;
}
...
//
//*****************************************************************************
static inline void EPWM_setTripZoneAdvAction(
    uint32_t base, EPWM_TripZoneAdvancedEvent tzAdvEvent, EPWM_TripZoneAdvancedAction tzAdvAction)
{
    //
    // Check the arguments
    //
    ...
    //
    EALLOW;
    HWREGH(base + EPWM_O_TZCTL2) = ((HWREGH(base + EPWM_O_TZCTL2) & ~(0x7U << (uint16_t)tzAdvEvent))
...
static inline void EPWM_setTripZoneAdvDigitalCompareActionA(
    uint32_t base, EPWM_TripZoneAdvDigitalCompareEvent tzAdvDCEvent, EPWM_TripZoneAdvancedAction tzAdvDCAction)
{
    //
    // Check the arguments
    //
    ...
    //
    EALLOW;
    HWREGH(base + EPWM_O_TZCTLDCA) = ((HWREGH(base + EPWM_O_TZCTLDCA) & ~(0x7U << (uint16_t)tzAdvDCEvent))
    ...
    uint32_t base, EPWM_TripZoneAdvDigitalCompareEvent tzAdvDCEvent, EPWM_TripZoneAdvancedAction tzAdvDCAction)
{
    ...
    //
    EALLOW;
    HWREGH(base + EPWM_O_TZCTLDCB) = ((HWREGH(base + EPWM_O_TZCTLDCB) & ~(0x7U << (uint16_t)tzAdvDCEvent))
                                      | ((uint16_t)tzAdvDCAction << (uint16_t)tzAdvDCEvent));
...
//
//*****************************************************************************
static inline void EPWM_enableTripZoneInterrupt(uint32_t base, uint16_t tzInterrupt)
{
    //
    // Check the arguments
    //
...
//
//***************************************************************************
static inline void EPWM_disableTripZoneInterrupt(uint32_t base, uint16_t tzInterrupt)
{
    //
    // Check the arguments
    //
    ...
    uint32_t base, EPWM_CycleByCycleTripZoneClearMode clearEvent)
{
    ...
    HWREGH(base + EPWM_O_TZCLR)
        = ((HWREGH(base + EPWM_O_TZCLR) & ~EPWM_TZCLR_CBCPULSE_M) | ((uint16_t)clearEvent << EPWM_TZCLR_CBCPULSE_S));
    EDIS;
}
...
//
//***************************************************************************
static inline void EPWM_clearCycleByCycleTripZoneFlag(uint32_t base, uint16_t tzCBCFlags)
{
    //
    // Check the arguments
    //
...
//
//***************************************************************************
static inline void EPWM_clearOneShotTripZoneFlag(uint32_t base, uint16_t tzOSTFlags)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setInterruptSource(uint32_t base, uint16_t interruptSource)
{
    uint16_t intSource;
    ...
    if ((interruptSource == EPWM_INT_TBCTR_U_CMPC) || (interruptSource == EPWM_INT_TBCTR_U_CMPD)
        || (interruptSource == EPWM_INT_TBCTR_D_CMPC) || (interruptSource == EPWM_INT_TBCTR_D_CMPD))
    {
        //
    ...
    else if ((interruptSource == EPWM_INT_TBCTR_U_CMPA) || (interruptSource == EPWM_INT_TBCTR_U_CMPB)
             || (interruptSource == EPWM_INT_TBCTR_D_CMPA) || (interruptSource == EPWM_INT_TBCTR_D_CMPB))
    {
    ...
    //
    HWREGH(base + EPWM_O_ETSEL) = ((HWREGH(base + EPWM_O_ETSEL) & ~EPWM_ETSEL_INTSEL_M) | intSource);
}
...
//
//*****************************************************************************
static inline void EPWM_setInterruptEventCountInitValue(uint32_t base, uint16_t eventCount)
{
    //
    // Check the arguments
    //
    ...
    HWREGH(base + EPWM_O_ETCNTINIT)
        = ((HWREGH(base + EPWM_O_ETCNTINIT) & ~EPWM_ETCNTINIT_INTINIT_M) | (uint16_t)(eventCount & 0xFU));
}
...
//
//*****************************************************************************
static inline void EPWM_enableADCTrigger(uint32_t base, EPWM_ADCStartOfConversionType adcSOCType)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_disableADCTrigger(uint32_t base, EPWM_ADCStartOfConversionType adcSOCType)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setADCTriggerSource(
    uint32_t base, EPWM_ADCStartOfConversionType adcSOCType, EPWM_ADCStartOfConversionSource socSource)
{
    uint16_t source;
    ...
    if ((socSource == EPWM_SOC_TBCTR_U_CMPC) || (socSource == EPWM_SOC_TBCTR_U_CMPD)
        || (socSource == EPWM_SOC_TBCTR_D_CMPC) || (socSource == EPWM_SOC_TBCTR_D_CMPD))
    {
    ...
    if (adcSOCType == EPWM_SOC_A)
    {
        ...
        //
        if ((socSource == EPWM_SOC_TBCTR_U_CMPA) || (socSource == EPWM_SOC_TBCTR_U_CMPB)
            || (socSource == EPWM_SOC_TBCTR_D_CMPA) || (socSource == EPWM_SOC_TBCTR_D_CMPB))
        {
            //
            // Enable events based on comp A or comp B
            //
        ...
        else if ((socSource == EPWM_SOC_TBCTR_U_CMPC) || (socSource == EPWM_SOC_TBCTR_U_CMPD)
                 || (socSource == EPWM_SOC_TBCTR_D_CMPC) || (socSource == EPWM_SOC_TBCTR_D_CMPD))
        {
            //
            // Enable events based on comp C or comp D
...
//
//*****************************************************************************
static inline void EPWM_setADCTriggerEventPrescale(
    uint32_t base, EPWM_ADCStartOfConversionType adcSOCType, uint16_t preScaleCount)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline bool EPWM_getADCTriggerFlagStatus(uint32_t base, EPWM_ADCStartOfConversionType adcSOCType)
{
    //
    // Check the arguments
    //
    ...
    //
    return ((((HWREGH(base + EPWM_O_ETFLG) >> ((uint16_t)adcSOCType + 2U)) & 0x1U) == 0x1U) ? true : false);
}
...
//
//*****************************************************************************
static inline void EPWM_clearADCTriggerFlag(uint32_t base, EPWM_ADCStartOfConversionType adcSOCType)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_enableADCTriggerEventCountInit(uint32_t base, EPWM_ADCStartOfConversionType adcSOCType)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_disableADCTriggerEventCountInit(uint32_t base, EPWM_ADCStartOfConversionType adcSOCType)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_forceADCTriggerEventCountInit(uint32_t base, EPWM_ADCStartOfConversionType adcSOCType)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setADCTriggerEventCountInitValue(
    uint32_t base, EPWM_ADCStartOfConversionType adcSOCType, uint16_t eventCount)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline uint16_t EPWM_getADCTriggerEventCount(uint32_t base, EPWM_ADCStartOfConversionType adcSOCType)
{
    uint16_t eventCount;
...
//
//*****************************************************************************
static inline void EPWM_forceADCTrigger(uint32_t base, EPWM_ADCStartOfConversionType adcSOCType)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_selectDigitalCompareTripInput(
    uint32_t base, EPWM_DigitalCompareTripInput tripSource, EPWM_DigitalCompareType dcType)
{
    //
    // Check the arguments
    //
    ...
    //
    EALLOW;
    HWREGH(base + EPWM_O_DCTRIPSEL) = ((HWREGH(base + EPWM_O_DCTRIPSEL) & ~(0xFU << ((uint16_t)dcType << 2U)))
...
//
//*****************************************************************************
static inline void EPWM_setDigitalCompareBlankingEvent(uint32_t base, EPWM_DigitalCompareBlankingPulse blankingPulse)
{
    //
    // Check the arguments
    //
...
static inline void EPWM_setDigitalCompareFilterInput(uint32_t base, EPWM_DigitalCompareFilterInput filterInput)
{
    ...
    //
    EALLOW;
    HWREGH(base + EPWM_O_DCFCTL) = ((HWREGH(base + EPWM_O_DCFCTL) & ~EPWM_DCFCTL_SRCSEL_M) | ((uint16_t)filterInput));
    EDIS;
}
...
//
//*****************************************************************************
static inline void EPWM_setDigitalCompareEdgeFilterMode(uint32_t base, EPWM_DigitalCompareEdgeFilterMode edgeMode)
{
    //
    // Check the arguments
    //
    ...
    HWREGH(base + EPWM_O_DCFCTL)
        = (HWREGH(base + EPWM_O_DCFCTL) & ~EPWM_DCFCTL_EDGEMODE_M) | ((uint16_t)edgeMode << EPWM_DCFCTL_EDGEMODE_S);
    EDIS;
}
...
//
//*****************************************************************************
static inline void EPWM_setDigitalCompareWindowOffset(uint32_t base, uint16_t windowOffsetCount)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setDigitalCompareWindowLength(uint32_t base, uint16_t windowLengthCount)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline uint16_t EPWM_getDigitalCompareBlankingWindowOffsetCount(uint32_t base)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline uint16_t EPWM_getDigitalCompareBlankingWindowLengthCount(uint32_t base)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setDigitalCompareEventSource(uint32_t base, EPWM_DigitalCompareModule dcModule,
    EPWM_DigitalCompareEvent dcEvent, EPWM_DigitalCompareEventSource dcEventSource)
{
    uint32_t registerOffset;
    ...
    {
        HWREGH(base + registerOffset)
            = ((HWREGH(base + registerOffset) & ~EPWM_DCACTL_EVT1SRCSEL) | (uint16_t)dcEventSource);
    }
    else
    {
        HWREGH(base + registerOffset)
            = ((HWREGH(base + registerOffset) & ~EPWM_DCACTL_EVT2SRCSEL) | ((uint16_t)dcEventSource << 8U));
    }
    EDIS;
}
...
//
//*****************************************************************************
static inline void EPWM_setDigitalCompareEventSyncMode(uint32_t base, EPWM_DigitalCompareModule dcModule,
    EPWM_DigitalCompareEvent dcEvent, EPWM_DigitalCompareSyncMode syncMode)
{
    ...
    {
        HWREGH(base + registerOffset)
            = ((HWREGH(base + registerOffset) & ~EPWM_DCACTL_EVT1FRCSYNCSEL) | ((uint16_t)syncMode << 1U));
    }
    else
    {
        HWREGH(base + registerOffset)
            = ((HWREGH(base + registerOffset) & ~EPWM_DCACTL_EVT2FRCSYNCSEL) | ((uint16_t)syncMode << 9U));
    }
    EDIS;
}
...
//
//*****************************************************************************
static inline void EPWM_enableDigitalCompareADCTrigger(uint32_t base, EPWM_DigitalCompareModule dcModule)
{
    uint32_t registerOffset;
    ...
    //
    EALLOW;
    HWREGH(base + registerOffset) = (HWREGH(base + registerOffset) | EPWM_DCACTL_EVT1SOCE);
    EDIS;
}
...
//
//*****************************************************************************
static inline void EPWM_disableDigitalCompareADCTrigger(uint32_t base, EPWM_DigitalCompareModule dcModule)
{
    uint32_t registerOffset;
...
//
//*****************************************************************************
static inline void EPWM_enableDigitalCompareSyncEvent(uint32_t base, EPWM_DigitalCompareModule dcModule)
{
    uint32_t registerOffset;
    ...
    //
    EALLOW;
    HWREGH(base + registerOffset) = (HWREGH(base + registerOffset) | EPWM_DCACTL_EVT1SYNCE);
    EDIS;
}
...
//
//*****************************************************************************
static inline void EPWM_disableDigitalCompareSyncEvent(uint32_t base, EPWM_DigitalCompareModule dcModule)
{
    uint32_t registerOffset;
...
//
//*****************************************************************************
static inline void EPWM_setDigitalCompareCounterShadowMode(uint32_t base, bool enableShadowMode)
{
    //
    // Check the arguments
    //
...
static inline bool EPWM_getDigitalCompareCaptureStatus(uint32_t base)
{
    ...
    //
    return ((HWREGH(base + EPWM_O_DCCAPCTL) & EPWM_DCCAPCTL_CAPSTS) == EPWM_DCCAPCTL_CAPSTS);
}
...
//
//*****************************************************************************
static inline void EPWM_enableDigitalCompareTripCombinationInput(
...
//
//*****************************************************************************
static inline void EPWM_setValleyTriggerSource(uint32_t base, EPWM_ValleyTriggerSource trigger)
{
    //
    // Check the arguments
    //
    ...
    HWREGH(base + EPWM_O_VCAPCTL)
        = ((HWREGH(base + EPWM_O_VCAPCTL) & ~EPWM_VCAPCTL_TRIGSEL_M) | ((uint16_t)trigger << 2U));
    EDIS;
}
...
//
//*****************************************************************************
static inline void EPWM_setValleyTriggerEdgeCounts(uint32_t base, uint16_t startCount, uint16_t stopCount)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setValleySWDelayValue(uint32_t base, uint16_t delayOffsetValue)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_setValleyDelayDivider(uint32_t base, EPWM_ValleyDelayMode delayMode)
{
    //
    // Check the arguments
    //
    ...
    EALLOW;
    HWREGH(base + EPWM_O_VCAPCTL)
        = ((HWREGH(base + EPWM_O_VCAPCTL) & ~EPWM_VCAPCTL_VDELAYDIV_M) | ((uint16_t)delayMode << 7U));
    EDIS;
}
...
//
//*****************************************************************************
static inline bool EPWM_getValleyEdgeStatus(uint32_t base, EPWM_ValleyCounterEdge edge)
{
    //
    // Check the arguments
    //
    ...
    if (edge == EPWM_VALLEY_COUNT_START_EDGE)
    {
        ...
        //
        return (
            ((HWREGH(base + EPWM_O_VCNTCFG) & EPWM_VCNTCFG_STARTEDGESTS) == EPWM_VCNTCFG_STARTEDGESTS) ? true : false);
    }
    else
    {
        //
        ...
        //
        return (
            ((HWREGH(base + EPWM_O_VCNTCFG) & EPWM_VCNTCFG_STOPEDGESTS) == EPWM_VCNTCFG_STOPEDGESTS) ? true : false);
    }
}
...
//
//*****************************************************************************
static inline void EPWM_setGlobalLoadTrigger(uint32_t base, EPWM_GlobalLoadTrigger loadTrigger)
{
    //
    // Check the arguments
    //
    ...
    HWREGH(base + EPWM_O_GLDCTL)
        = ((HWREGH(base + EPWM_O_GLDCTL) & ~EPWM_GLDCTL_GLDMODE_M) | ((uint16_t)loadTrigger << EPWM_GLDCTL_GLDMODE_S));
    EDIS;
}
...
//
//*****************************************************************************
static inline void EPWM_setGlobalLoadEventPrescale(uint32_t base, uint16_t prescalePulseCount)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_enableGlobalLoadRegisters(uint32_t base, uint16_t loadRegister)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_disableGlobalLoadRegisters(uint32_t base, uint16_t loadRegister)
{
    //
    // Check the arguments
    //
...
//
//*****************************************************************************
static inline void EPWM_lockRegisters(uint32_t base, EPWM_LockRegisterGroup registerGroup)
{
    //
    // Check the arguments
    //
    ...
    //
    HWREG(base + EPWM_O_LOCK) = ((uint32_t)0xA5A50000U | ((uint32_t)registerGroup));
}
...
//
//*****************************************************************************
extern void EPWM_setEmulationMode(uint32_t base, EPWM_EmulationMode emulationMode);
...
//
//*****************************************************************************
extern void EPWM_configureSignal(uint32_t base, const EPWM_SignalParams *signalParams);
